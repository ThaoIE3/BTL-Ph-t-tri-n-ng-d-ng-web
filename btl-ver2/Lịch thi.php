			...
			<div class="notification">
				...
				<div class="row">
					<div class="col-lg-4 col-md-4 col-sm-4">
						Chọn: 
						<select>
							<option selected="">Xem lịch thi</option>
							<option><a href="http://localhost/btl-ver2/đăng kí thi.php">Đăng kí lịch thi</a></option>
						</select>
					...
					<div class="col-lg-4 col-md-4 col-sm-4">
						<div class="sum-exam"><a href="http://localhost/btl-ver2/Đăng kí thi.php">ĐĂNG KÝ</a></div>
					</div>
				</div>
				<div class="center">Không có dữ liệu về kì thi của sinh viên!</div>
			</div>
		</div>
	</div>
	<footer>
